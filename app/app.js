...
(function () {
  ...
  HeaderController.$inject = ['$rootScope', '$scope', '$state', '$translate', 'auth', 'data', 'toastr', 'User'];

  function HeaderController($rootScope, $scope, $state, $translate, auth, data, toastr, User) {
